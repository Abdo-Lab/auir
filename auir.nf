...
def help() {
    ...
    println ""
    println "    --reads         STR      location of FASTQ formatted input sequences"
    println "    --adapters      STR      location of FASTA formatted adapter sequences"
    println "    --host          STR      location of FASTA formatted host genome"
    println "    --index         STR      location of BWA generated index files"
    ...
    println "    --leading       INT"
    println "    --minlen        INT"
    println "    --slidingwindow INT"
    println "    --trailing      INT"
    println ""
